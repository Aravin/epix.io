...
const services = [
  ...
  {
    name: "Security",
    description: "Password Generator, Hash Generator and related.",
    href: "#",
    icon: ShieldCheckIcon,
  },
  {
    name: "HTTP Tools",
    description: "HTTP Mock Responses and Status Codes.",
    href: "#",
    icon: GlobeAltIcon,
  },
  {
    name: "Dev Tools",
    description: "JSON Viewer, Text Diff and related.",
    href: "#",
    icon: CodeIcon,
  },
  {
                  ...
                  {({ open }) => (
                    <>
                      ...
                      >
                        <Popover.Panel
                          static
                          className="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:right-1/2"
                        >
                  ...
                  {({ open }) => (
                    <>
                      ...
                      >
                        <Popover.Panel
                          static
                          className="absolute z-10 right-1/2 transform mt-3 px-2 w-screen max-w-md sm:px-0"
                        >
                          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                            <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                              {resources.map((item) => (
